...
export const aikonNftAuthorPublicKeys: string [] = [ process.env.NFT_PUBLIC_KEY1 as string, process.env.NFT_PUBLIC_KEY2 as string ]
export const aikonNftauthorPrivateKeys: string [] = [ process.env.NFT_PRIVATE_KEY1 as string, process.env.NFT_PRIVATE_KEY2 as string ]
